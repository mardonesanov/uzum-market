...
<div class="container mt-5">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td><i class="fas fa-hashtag"></i> <%= item.getQuantity() %></td>
            <td><i class="fas fa-dollar-sign"></i> $<%= item.getProduct().getPrice() %></td>
            <td><i class="fas fa-calculator"></i> $<%= item.getQuantity() * item.getProduct().getPrice() %></td>
            <td>
        ...
        <tr>
            ...
            <td colspan="2"><strong><i class="fas fa-dollar-sign"></i> $<%= totalAmount %></strong></td>
        </tr>
        </tfoot>
    </table>
